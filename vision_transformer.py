...
val_loader = utils.data.DataLoader(valid_set, batch_size=128)
test_loader = utils.data.DataLoader(test_set, batch_size=128)

# train the model (hint: here are some helpful Trainer arguments for rapid idea iteration)
trainer = L.Trainer(limit_train_batches=1.0, max_epochs=100, devices=1)
trainer.fit(
